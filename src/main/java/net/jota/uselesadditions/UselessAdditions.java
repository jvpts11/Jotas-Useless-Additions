...
import net.jota.uselesadditions.item.ModCreativeModeTabs;
...
public class UselessAdditions
{
    ...
    public UselessAdditions(IEventBus modEventBus, ModContainer modContainer)
    {
